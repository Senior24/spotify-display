...
Sometimes, when clicking button, events are processed with delay or are not processed at all. This is probably happens if multiple requests were sent at once. You can simply click button again and things should work
